 ...
 * generated in the com.cx.client.client01 package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://service.cx.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.cx.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cx.client.client01
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cx.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cx.com/", name = "queryWeatherResponse")
