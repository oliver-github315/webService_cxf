 ...
 * 2020-04-10T12:03:39.076+08:00
 * Generated source version: 3.1.17
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", 
                  wsdlLocation = "http://localhost:8989/cxf_webservice?wsdl",
...
public class WeatherServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8989/cxf_webservice?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8989/cxf_webservice?wsdl");
        }
        WSDL_LOCATION = url;
    }
